...
const threeUtils = {
  ...
  * etc...
  */
  periodicFunction: (x, period, minValue, maxValue) => {
  ...
  */
  circleFunction: (input, period, radius) => {
  ...
  */
  getRandomSphereCoordinate: (radius) => {
  ...
  */
  getRandomCylinderCoordinate: (radius, height) => {
